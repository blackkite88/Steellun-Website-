    ...
    >
      ...
      {isHovered && (
        <>
          ...
          <div id='cardx' className="fixed top-1/2 left-1/2 rounded-lg z-[1001] transform -translate-x-1/2 -translate-y-1/2 bg-white flex flex-row shadow-2xl transition-all duration-300 ease-in-out w-[310px] md:w-[470px] lg:w-[600px] h-[350px] scale:110 md:scale-150">
            <img
